                                                            ...
                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <select class="form-select js-select2" name="session_type" id="select-events">
                                                                            ...
                                                                            <option value="mulitple" @if($event->session_type == 'multiple') selected @endif >Multiple</option>
                                                                        </select>
                                                                    </div>
                                                            </div>
    ...
    $("body").delegate("#add_section","click",function(e){
        ...
        $('#modalDefault').modal("hide");
            ...
            if(selectval == 'text_editor'){
              ...
              $('.section_div1').append('<div>'+text_editor+'<input type="hidden" name="section_type" value="text-editor-section"><button type="submit" class="btn btn-primary" id="submitbutton">submit</button></div>');
            }else if(selectval == 'right_img_section'){
                // $('#section_select').children('option[value="right_img_section"]').attr('disabled','');
                $('.section_div1').append('<div>'+right_img_section+'<input type="hidden" name="section_type" value="right-image-section"><button type="submit" class="btn btn-primary" id="submitbutton">submit</button></div></div>');
            }else if(selectval == 'left_img_section'){
                // $('#section_select').children('option[value="left_img_section"]').attr('disabled','');
                $('.section_div1').append('<div>'+left_img_section+'<input type="hidden" name="section_type" value="left-image-section"><button type="submit" class="btn btn-primary" id="submitbutton">submit</button></div>');
            }else if(selectval == 'gallery_section'){
                // $('#section_select').children('option[value="gallery_section"]').attr('disabled','');
                $('.section_div1').append('<div>'+gallery_section+'<input type="hidden" name="section_type" value="gallery-section"><button type="submit" class="btn btn-primary" id="submitbutton">submit</button></div></div>');
            }else if(selectval == 'contact_section'){
                // $('#section_select').children('option[value="contact_section"]').attr('disabled','');
                $('.section_div1').append('<div>'+Contact_Section+'<input type="hidden" name="section_type" value="contact-section"><button type="submit" class="btn btn-primary" id="submitbutton">submit</button></div></div>');
            }else if(selectval == 'footer_section'){
                // $('#section_select').children('option[value="footer_section"]').attr('disabled','');
                $('.section_div1').append('<div>'+footer_section+'<input type="hidden" name="section_type" value="disclaimer_text"><button type="submit" class="btn btn-primary" id="submitbutton">submit</button></div></div>');
            }
            // editor code
