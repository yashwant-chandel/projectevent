                                             ...
                                             <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="default-01" name="title" placeholder="Event Title" value="{{ $event->title ?? '' }}">
                                                    <input type="file" id="imageInput" name="file" class="d-none"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label" for="default-01">Event Description</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control" id="default-01" name="subtitle" placeholder="Event Sub Title" value="{{ $event->sub_title ?? '' }}">
                                                     </div>
                                                </div>
                                                <div class="form-group">
                                ...
                                <!-- <div id="multiple-session mx-4"> -->
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                    <textarea class="form-control" name="multisesion_note" id="note">{{ $event->session['note'] ?? '' }}</textarea>
                                                                    </div> 
                                                                </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="session_div row mt-4">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="form-label" for="note">Note</label>
                                                                    <div class="form-control-wrap">
                                                                    <textarea class="form-control" name="singlesession_note" id="note">{{ $event->session['note'] ?? '' }}</textarea>
                                                                    </div> 
                                                                </div>
                                                               
                                                                </div>
                                                             </div>
                                                             <button class="btn btn-primary col-1 mt-3">Update</button>
                                                </div>
                                    </div>
                            </form>
                                    <div class="nk-block nk-block-lg">
                                    ...
                                    <div class="section_div py-4">
                                        ...
                                        @if($section->section_name == "text-editor-section")
                                            ...
                                            <div class="nk-block nk-block-lg py-4"><div class="card card-bordered card-preview p-4 "><div class="card-header d-flex justify-content-between"><h4>Contact Section</h4><div><button type="button" section-name="contact_section" link="{{ url('/admin-dashboard/section/delete/'.$section->id) }}" class="btn btn-link close_section_db"><i class="fas fa-times"></i></button>@if($i != 1)<a class="increasesection" section-id="{{ $section->id ?? '' }}" href=""><i class="fas fa-arrow-up"></i></a>@endif</div></div><div class="row"><div class="col-lg-6"><div class="form-group"><input type="hidden" name="section_type" value="{{ $section->section_name ?? '' }}"><input type="hidden" name="section_number" value="{{ $section->section_number ?? '' }}"><input type="hidden" name="id" value="{{ $section->id ?? '' }}"><label class="form-label" for="default-02">Title</label><div class="form-control-wrap"><input class="form-control" name="title" id="contact-section-title" value="{{ $section->title ?? '' }}"></div></div><div class="form-group "><label class="form-label" for="default-02">Address</label><div class="form-control-wrap"><input type="text" name="address" class="form-control" value="{{ $section->event_data['contact_section_address'] ?? '' }}"></div></div><div class="form-group "><label class="form-label" for="default-02">Contact Number</label><div class="form-control-wrap"><input type="text" name="phone" class="form-control" value="{{ $section->event_data['contact_section_contact'] ?? '' }}"></div></div></div><div class="col-lg-6"><div class="form-group "><label class="form-label" for="default-02">Email</label><div class="form-control-wrap"><input type="email" name="email" class="form-control" value="{{ $section->event_data['contact_section_email'] ?? '' }}"></div></div><div class="form-group "><label class="form-label" for="default-02">Site Address</label><div class="form-control-wrap"><input type="text" name="site_address" class="form-control" value="{{ $section->event_data['contact_section_site_address'] ?? '' }}"></div></div><div class="custom-control custom-checkbox mt-4"><input type="checkbox" class="custom-control-input" name="map" id="customCheck1{{ $num }}" value="1" @if($section->event_data['map_status'] == 1) checked @endif><label class="custom-control-label" for="customCheck1{{ $num }}">Map</label></div></div></div><div class="py-4"><button type="submit" class="btn btn-primary col-1">Update</button></div></div></div>
                                            @elseif($section->section_name == "disclaimer_text")
                                            <?php ?>
                                            <div class="nk-block nk-block-lg py-4"><div class="card card-bordered card-preview p-4 "><div class="card-header d-flex justify-content-between"><h4>Footer Section</h4><div><button type="button" section-name="footer_section" link="{{ url('/admin-dashboard/section/delete/'.$section->id) }}" class="btn btn-link close_section_db"><i class="fas fa-times"></i></button>@if($i != 1)<a class="increasesection" section-id="{{ $section->id ?? '' }}" href=""><i class="fas fa-arrow-up"></i></a>@endif</div></div><div class="col-lg-12"><div class="form-group"><input type="hidden" name="section_type" value="{{ $section->section_name ?? '' }}"><input type="hidden" name="section_number" value="{{ $section->section_number ?? '' }}"><input type="hidden" name="id" value="{{ $section->id ?? '' }}"><label class="form-label" for="default-02">Title</label><div class="form-control-wrap"><input class="form-control" name="title" id="footer-section-title" value="{{ $section->title ?? '' }}"></div></div><div class="form-group "><label class="form-label" for="editor">Disclaimer</label><div class="form-control-wrap"><textarea class="form-control" name="disclaimer_text" id="editor-text-section{{ $num }}">{{ $section->event_data['footer_disclaimer'] ?? '' }}</textarea></div></div></div><div class="py-4"><button type="submit" class="btn btn-primary col-1">Update</button></div></div></div>
                                            @endif
                                            </form>
                                            <script>
